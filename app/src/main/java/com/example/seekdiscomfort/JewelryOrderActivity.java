...
public class JewelryOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jewelry_order);
        ...
        go_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent2 = new Intent(JewelryOrderActivity.this, JewelryActivity.class);
        ...
        confirm_order.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!TextUtils.isEmpty(full_name.getText().toString()) && !TextUtils.isEmpty(contact_number.getText().toString()) && !TextUtils.isEmpty(street_address.getText().toString()) && !TextUtils.isEmpty(city.getText().toString()))
                {
                    ...
                    Toast.makeText(JewelryOrderActivity.this, "Order Successfully Received\nThanks for Ordering", Toast.LENGTH_SHORT).show();

                    Intent i = new Intent(JewelryOrderActivity.this, OrdersListActivity.class);
                ...
                else
                {
                    ...
                    {
                        full_name.setError("");
                        Toast.makeText(JewelryOrderActivity.this, "Full Name must be Filled", Toast.LENGTH_SHORT).show();
                    }
                    if (TextUtils.isEmpty(contact_number.getText().toString()))
                    {
                        contact_number.setError("");
                        Toast.makeText(JewelryOrderActivity.this, "Contact Number must be Filled", Toast.LENGTH_SHORT).show();
                    }
                    if (TextUtils.isEmpty(street_address.getText().toString()))
                    {
                        street_address.setError("");
                        Toast.makeText(JewelryOrderActivity.this, "Street Address must be Filled", Toast.LENGTH_SHORT).show();
                    }
                    if (TextUtils.isEmpty(city.getText().toString()))
                    {
                        city.setError("");
                        Toast.makeText(JewelryOrderActivity.this, "City Name must be Filled", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
