...
public class SeekersEssential extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seekers_essential);
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (quantity_of_prod_one == 0 && quantity_of_prod_two == 0 && quantity_of_prod_three == 0 && quantity_of_prod_four == 0 && quantity_of_prod_five == 0)
                {
                    ...
                    Toast.makeText(SeekersEssential.this, "No Item is Selected.", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    ...
                    Intent intent = new Intent(SeekersEssential.this, SeekersCart.class);
        ...
        proceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    Intent intent = new Intent(SeekersEssential.this, OrderActivity.class);
                    intent.putExtra("key_one", s1);
                    intent.putExtra("key_two", s2);
                    intent.putExtra("key_three", s3);
                    intent.putExtra("key_four", s4);
